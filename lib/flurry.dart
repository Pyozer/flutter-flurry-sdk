...
class Flurry {
  ...
  static void addOriginWithParameters(
    String originName,
  ...
  static void onErrorWithParameters(
    String errorId,
    String message,
    String errorClass,
    Map<String, String> parameters,
  ...
  static Future<EventRecordStatus> logPayment(
    ...
    int eventRecordStatus = await flurryAgent!.logPayment(
      productName,
      productId,
      quantity,
      price,
...
class Config {
  ...
  Future<String?> getConfigString(String key, String defaultValue) async {
    return configAgent?.getConfigString(key, defaultValue);
  }
}
...
class PublisherSegmentation {
  ...
  Future<bool> isFetchFinished() async {
    ...
    return publisherSegmentationAgent!.isFetchFinished();
  }
  ...
  Future<Map<String, String>?> getPublisherData() async {
    ...
    return publisherSegmentationAgent!.getPublisherData();
  }
}
